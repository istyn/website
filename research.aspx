...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>We placed the resources on a population density map from the US Census Bureau and tallied the number of people within a radius of the provider.&nbsp; This gives an estimate of the number of people within driving distance of each resource.&nbsp; To approxiate the nonlinear relation that distance has on its availability, a 2D Gaussian curve was applied to the population.</p>
    <br />
